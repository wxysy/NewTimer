...
namespace TimerLib
{
    public class TimerStarter
    {
        ...
        public static CountDownTimer CreatCountDownTimer(int countDownSeconds, Brush countDownColor, int warningSeconds, Brush warningColor, int timerInterval, bool allowUIOperation, EventHandler? zeroEvent, EventHandler<int>? timerClosingEvent, EventHandler<int>? timerTickEvent)
        {
